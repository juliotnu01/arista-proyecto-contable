                    ...
                    <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-50 dark:bg-gray-800">
                                <tr>
                                    <th v-for="(column, c) in tableData.data.cabecera" :key="c"
                                        class="px-2 py-3.5 text-sm font-normal text-center  text-gray-500 dark:text-gray-400">
                                        {{ column.label }}
                                    </th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                ...
                                <tr v-for="(item, index) in tableData.data.body" :key="index">
                                    <slot name="body" :row="{item, index}"  ></slot>
                                </tr>
                            </tbody>
                        </table>
                    </div>
